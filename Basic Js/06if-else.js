// * ----- if else condition ( Which condition is ture that code will execute. Other code will skip) ---- *
...
//003) if else-if else condition (Here we have minimum three or more than three condition)
age = 18;
if (age > 18) {
  console.log("Your are above 18 years");
} else if (age == 18) {
  console.log("Your are 18 years");
} else {                                // Here else if part is executed
  console.log("Your are not above 18 years");
}
